...
Con esta información podemos obtener una odometría visual del carro y saber en qué parte del mapa se encuentra. Mientras va mapeando el carro, se van guardando estos conjuntos de características en imágenes y va dejando nodos en el mapa (posición). Cuando el robot ha dado una vuelta completa al interior y regresa a su punto inicial, reconoce que ya estuvo en ese lugar y por lo tanto que existe un cierre de bucle. Esto hará que se acomoden el resto de los nodos por medio de “resortes virtuales” que conectan a los nodos.
